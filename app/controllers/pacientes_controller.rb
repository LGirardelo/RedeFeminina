class PacientesController < PessoasController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:pessoa_id, :numerocartaosus, :profissao, :enderecoprofissional, :enderecoresidencial, :nomeconjugue, :contatoconjugue, :string, :profissaoconjugue, :possuifilhos, :filhosquantidade, :idadefilhos, :observacao, :localnascimento, :datacadastro, :dataobito, :ativo)
    end
end
